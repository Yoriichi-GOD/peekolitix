...
const UpgradeModal = () => {
  ...
  const [selectingMethod, setSelectingMethod] = React.useState(null);
  ...
  const handleUpgrade = async (planKey) => {
    ...
    if (isNative && selectingMethod !== planKey) {
        ...
        >
          ...
          >
            ...
            <div className="steps-list" style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              {[
                { n: '01', t: <>Open <a href="https://peekolitix.in" target="_blank" style={{color: '#fff', textDecoration: 'underline'}}>peekolitix.in</a> on a PC browser.</> },
